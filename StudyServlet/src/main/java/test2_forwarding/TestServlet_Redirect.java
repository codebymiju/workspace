...
public class TestServlet_Redirect extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("TestServlet_Redirect 이거다 - doProcess()");
		...
		response.sendRedirect("test2_forwarding/test_redirect_result.jsp"); // 이 경로안에 위치
//		response.sendRedirect("test6_redirect_result.jsp"); // 현재위치(앞에 경로지정 없기에)
